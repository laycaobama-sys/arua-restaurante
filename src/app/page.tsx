    ...
    <section id="reservas" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <a 
            href="https://www.gloriafood.com/restaurants/a-rua-hortaleza-madrid/reservation" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-full sm:w-auto px-8 py-4 bg-[#c9a227] text-black font-semibold text-base uppercase tracking-wider rounded-lg hover:bg-[#e3c453] transition-all flex items-center justify-center gap-3 shadow-lg"
          >
        ...
        <div className="bg-[#1a1a1a]/90 backdrop-blur rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-[#2a2a2a] shadow-2xl">
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 text-center">¿Cómo funciona?</h3>
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              { step: '1', title: 'Elige fecha y hora', desc: 'Selecciona cuándo quieres venir' },
              { step: '2', title: 'Indica comensales', desc: '¿Cuántas personas seréis?' },
              { step: '3', title: '¡Confirmado!', desc: 'Recibirás confirmación inmediata' },
            ].map((item, i) => (
              <div key={i} className="text-center">
                ...
                <p className="text-[#909090] text-sm">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
